      ...
      <div className="navbar-container">
        ...
        <div className="navbar-brand">
          <div className="logo-icon">
            <svg viewBox="0 0 24 24" className="medical-cross">
        ...
        <ul className={`navbar-menu ${isMenuOpen ? 'mobile-active' : ''}`}>
          ...
          <li className="navbar-item">
            <Link to="/symp-check" className="navbar-link" onClick={closeMenu}>
              <svg className="nav-icon" viewBox="0 0 24 24">
          ...
          <li className="navbar-item">
            <Link to="/assess-center" className="navbar-link" onClick={closeMenu}>
              <svg className="nav-icon" viewBox="0 0 24 24">
